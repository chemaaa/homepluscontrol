...
def test_light_module_str(test_light):
    module_str = "Home+ Light: device->Light, name->Light Module 1, id->module_id_3, reachable->False, status->, bridge->00:11:22:33:44:55"
    assert test_light.__str__() == module_str


def test_light_read_status(async_mock_plant):
    mock_plant, loop = async_mock_plant
    mock_light = mock_plant.modules["aa:11:11:32:11:ae:df:11"]
...
def test_light_update_status(async_mock_plant):
    ...
    assert status_result["on"] is False
